				...
				<div className={styles.cartOverlay} onClick={() => setIsOpen(false)}>
					<div className={styles.cartPopup} onClick={(e) => e.stopPropagation()}>
						...
						<div className={styles.cartContent}>
							...
							{(selectedWatchModel || selectedStrapModel) && (
								<div className={styles.cartItemCard}>
									...
									<div className={styles.cartItemDetails}>
										...
										{selectedFrameColor && (
											<div className={styles.cartItemDetail}>
												...
												<span className={styles.cartItemDetailValue}>
													<span 
														className={styles.cartColorPreview}
														style={{ backgroundColor: selectedFrameColor.color_code || '#e9e9e9' }}
													/>
										...
										{selectedLeatherColor && (
											<div className={styles.cartItemDetail}>
												...
												<span className={styles.cartItemDetailValue}>
													<span 
														className={styles.cartColorPreview}
														style={{ backgroundColor: selectedLeatherColor.color_code || '#e9e9e9' }}
													/>
										...
										{selectedStitchingColor && (
											<div className={styles.cartItemDetail}>
												...
												<span className={styles.cartItemDetailValue}>
													<span 
														className={styles.cartColorPreview}
														style={{ backgroundColor: selectedStitchingColor.color_code || '#e9e9e9' }}
													/>
										...
										{selectedEdgeColor && (
											<div className={styles.cartItemDetail}>
												...
												<span className={styles.cartItemDetailValue}>
													<span 
														className={styles.cartColorPreview}
														style={{ backgroundColor: selectedEdgeColor.color_code || '#e9e9e9' }}
													/>
										...
										{selectedBuckleColor && (
											<div className={styles.cartItemDetail}>
												...
												<span className={styles.cartItemDetailValue}>
													<span 
														className={styles.cartColorPreview}
														style={{ backgroundColor: selectedBuckleColor.color_code || '#e9e9e9' }}
													/>
										...
										{selectedAdapterColor && (
											<div className={styles.cartItemDetail}>
												...
												<span className={styles.cartItemDetailValue}>
													<span 
														className={styles.cartColorPreview}
														style={{ backgroundColor: selectedAdapterColor.color_code || '#e9e9e9' }}
													/>
										...
										{/* Количество */}
										<div className={styles.cartItemDetail}>
											<span className={styles.cartItemDetailLabel}>Количество:</span>
											<div className={styles.cartQuantityControls}>
												<button 
													className={styles.cartQuantityButton}
													onClick={() => configuratorStore.decreaseQuantity()}
													disabled={productAmount <= 1}
												>
													−
												</button>
												<span className={styles.cartQuantityValue}>{productAmount}</span>
												<button 
													className={styles.cartQuantityButton}
													onClick={() => configuratorStore.increaseQuantity()}
										...
										<div className={styles.cartItemDetail}>
											<span className={styles.cartItemDetailLabel}>Цена:</span>
											<span className={styles.cartItemDetailValue}>{totalPrice}₽</span>
										</div>
									</div>
									
									{/* Кнопки для текущего товара */}
									{configuratorStore.editingCartItemId && (
										<div className={styles.cartItemActions}>
											<button 
												className={styles.cartItemCancelEditButton}
												onClick={(e) => {
													e.stopPropagation()
													configuratorStore.cancelEditCartItem()
												}}
