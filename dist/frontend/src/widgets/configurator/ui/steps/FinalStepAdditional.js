...
exports.FinalStepAdditional = (0, mobx_react_lite_1.observer)(function FinalStepAdditional({ className }) {
    ...
    return (<div className={`${FinalStepAdditional_module_css_1.default.additional} ${className || ''}`}>
			{additionalOptions.map((option) => (<div key={option.option_name} className={`${FinalStepAdditional_module_css_1.default.additionalOption} ${option.choosen ? FinalStepAdditional_module_css_1.default.choosen : ''} ${(option.option_name === 'initials' || option.option_name === 'postcard') ? FinalStepAdditional_module_css_1.default.captionOption : ''}`}>
